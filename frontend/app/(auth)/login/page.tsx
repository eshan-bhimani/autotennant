    ...
    <div className="flex min-h-screen">
      ...
      >
        ...
        <div>
          ...
          >
            From listing to lease in days, not weeks. Join thousands of landlords automating their rental workflow.
          </motion.p>
        </div>
        ...
        >
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="bg-[#0B1628] px-3 text-white/30">or</span>
            </div>
          </div>
